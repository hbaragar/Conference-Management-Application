...
ActiveRecord::Schema.define(:version => 20130827174536) do
  ...
  create_table "conferences", :force => true do |t|
    ...
    t.string  "logo_url"
    t.integer "position"
    t.integer "general_portfolio_id"
  end

  add_index "conferences", ["general_portfolio_id"], :name => "index_conferences_on_general_portfolio_id"
  ...
  create_table "deferred_deletions", :force => true do |t|
    t.integer  "joomla_article_id"
  ...
  create_table "external_reviewers", :force => true do |t|
    t.integer  "cfp_id"
    t.string   "name"
  ...
  add_index "external_reviewers", ["cfp_id"], :name => "index_external_reviewers_on_cfp_id"
  ...
  add_index "portfolios", ["joomla_article_id"], :name => "index_portfolios_on_joomla_article_id"
