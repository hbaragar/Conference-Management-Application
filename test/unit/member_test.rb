...
class MemberTest < ActiveSupport::TestCase
  ...
  def test_create_permissions
    ...
    assert !new_member.creatable_by?(users(:a_colocated_conference_chair))
  end
  ...
  def test_update_permissions
    ...
    assert !@member.updatable_by?(users(:a_colocated_conference_chair))
    ...
    assert !@a_portfolio_chair.updatable_by?(users(:a_colocated_conference_chair))
  ...
  def test_destroy_permissions
    ...
    assert !@member.destroyable_by?(users(:a_colocated_conference_chair))
    ...
    assert !@a_portfolio_chair.destroyable_by?(users(:a_colocated_conference_chair))
  end
